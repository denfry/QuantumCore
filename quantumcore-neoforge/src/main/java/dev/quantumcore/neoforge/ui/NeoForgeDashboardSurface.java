package dev.quantumcore.neoforge.ui;
...
@NotThreadSafe
public final class NeoForgeDashboardSurface implements DashboardSurface {
    private final GuiGraphics graphics;
    private final int width;
    private final int height;

    public NeoForgeDashboardSurface(GuiGraphics graphics, int width, int height) {
